...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { css: @block.css, html: @block.html, name: @block.name, position: @block.position } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { css: @block.css, html: @block.html, name: @block.name, position: @block.position } }
